<template>
    <section class="py-16 px-4 max-w-7xl mx-auto">
      <div class="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
        <!-- Code Illustration -->
        <div class="">
           <img src="@/assets/img/versatile.png" />
        </div>
        
        <!-- Text Content -->
        <div>
          <h2 class="text-4xl font-bold mb-6 leading-tight">A versatile API designed to empower businesses of all sizes.</h2>
  ...
  import { Zap, Rocket } from 'lucide-vue-next';
  </script>