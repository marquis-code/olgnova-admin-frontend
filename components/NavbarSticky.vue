<template>
    <header class="fixed top-0 left-0 right-0 z-50">
      <div class="backdrop-blur-sm bg-white/10 mt-6 border-b max-w-7xl mx-auto rounded-full border-white/10">
        <div class="max-w-6xl mx-auto px-4 md:px-8 py-4 flex items-center justify-between">
          ...
          <nav class="hidden md:flex items-center space-x-8">
            <div class="relative group">
              <button @click="toggleProductsDropdown" class="text-white flex items-center">
                Products
                <ChevronDown class="ml-1 h-4 w-4 transition-transform duration-300" :class="{ 'rotate-180': isProductsDropdownOpen }" />
              </button>
