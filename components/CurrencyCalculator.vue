<template>
  <div class="">
    <div
      class="w-full max-w-md rounded-3xl overflow-hidden bg-[#5cb85c] pt-6 p-2"
    >
      <div class="bg-white rounded-2xl p-6 space-y-6">
        <div>
          <label class="text-[#1A1A1B] text-base font-medium"
            >Enter amount</label
          >
          <div class="flex justify-between items-center">
            ...
            />
            <div
              class="flex items-center space-x-2 bg-gray-100 px-4 py-2 rounded-full cursor-pointer"
        ...
        <div>
          ...
          <div class="flex justify-between items-center">
            ...
            <input
              ...
              type="text"
              disabled
              class="text-2xl bg-white font-semibold  disabled:opacity-90  focus:outline-none w-1/2"
            />
            <div
              class="flex items-center space-x-2  bg-gray-100 px-4 py-2 rounded-full cursor-pointer"
        ...
        <div class="space-y-3 mt-6">
          ...
          <div class="flex justify-between items-center">
            <div class="flex items-center">
              ...
              <div class="text-[#1A1A1B]">
                <!-- {{ amountToConvert }}  -->
                <input
                  v-model="amountToConvert"
                  type="text"
                  disabled
                  class="text-[#1A1A1B]  bg-white py-0 disabled:opacity-90 w-1/2  focus:outline-none"
                />
